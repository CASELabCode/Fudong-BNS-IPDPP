...
def get_args_parser():
    parser = argparse.ArgumentParser('BNS linear probing', add_help=False)

    parser.add_argument('--epochs', default=100, type=int, help='number of total epochs to run')
    parser.add_argument('--batch_size', default=64, type=int,
                        help='Batch size per GPU (effective batch size is batch_size * accum_iter * # gpus')
    parser.add_argument('--imbalanced_factor', default=100, type=int, help='number of classes')
    ...
    parser.add_argument('--num_samples', default=100, type=int, help='number of samples per class')
    parser.add_argument('--num_views', default=2, type=int, help='pairs of data augmentation')
    # dataset
    ...
    parser.add_argument('--output_dir', default='./output_dir/cifar10/lineprob_bns_cifar10',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir/cifar10/lineprob_bns_cifar10',
...
def main(args):
    ...
    train_set = ImbalanceCIFAR10(root=args.data_root, imb_factor=1/args.imbalanced_factor, train=True, transform=train_transform, download=True)
    ...
    class_counts = compute_class_counts(train_set)
    many_shot_classes, medium_shot_classes, few_shot_classes = categorize_classes(class_counts)

    train_set = sampler.sample_balanced_subset(train_set, samples_per_class=args.num_samples)
