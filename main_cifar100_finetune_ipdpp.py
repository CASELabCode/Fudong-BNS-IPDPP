...
def get_args_parser():
    parser = argparse.ArgumentParser('IP-DPP Fine-tuning on CIFAR-100', add_help=False)
    ...
    parser.add_argument('--sampling_freq', default=20, type=int, help='frequency of sampling')
    ...
    parser.add_argument('--output_dir', default='./output_dir/cifar100/finetune_ipdpp_cifar100',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir/cifar100/finetune_ipdpp_cifar100',
...
def main(args):
    ...
    sampler = IPDPPSampler(original_train_set.data, np.array(original_train_set.targets), class_num=args.num_classes, batch_size=args.batch_size,
    ...
    sample_total_time = time.time() - start_time
    sample_total_time_str = str(datetime.timedelta(seconds=int(sample_total_time)))
    print('Training time {}'.format(sample_total_time_str))
